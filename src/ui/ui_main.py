...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.search_tab.addTab(self.tab2, "")

        self.verticalLayout.addWidget(self.search_tab)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.search_tab.setTabText(self.search_tab.indexOf(self.tab1), QCoreApplication.translate("MainWindow", u"Tab 1", None))
        self.search_tab.setTabText(self.search_tab.indexOf(self.tab2), QCoreApplication.translate("MainWindow", u"Tab 2", None))
    # retranslateUi
